#include "ExtensionsSettingsOLD.h"
#include "ui_ExtensionsSettingsOLD.h"
...
// Shortcut ------------------------------------------------------------------------------------------------------------
ExtensionsSettingsOLD::Shortcut::Shortcut(ExtensionsSettingsOLD *parent)
    : QObject(parent),
...
ExtensionsSettingsOLD::Shortcut::~Shortcut() {
    if (messageHook) UnhookWindowsHookEx(messageHook);
    UnregisterHotKey(nullptr, 1);
}

bool ExtensionsSettingsOLD::Shortcut::registerShortcut(QLineEdit* shortcutLineEdit) const {
    QStringList parts;
...
bool ExtensionsSettingsOLD::Shortcut::eventFilter(QObject *watched, QEvent *event) {
...
LRESULT ExtensionsSettingsOLD::Shortcut::trigger(const int nCode, const WPARAM wParam, const LPARAM lParam) {
    if (nCode == HC_ACTION) {
...
// Extensions Settings -------------------------------------------------------------------------------------------------
ExtensionsSettingsOLD::ExtensionsSettingsOLD(QWidget *parent) : QDialog(parent),
                                                          ui(new Ui::ExtensionsSettingsOLD),
    ...
    connect(ui->closeButton, &QToolButton::clicked, this, &ExtensionsSettingsOLD::saveSettings);
    connect(ui->resetButton, &QToolButton::clicked, this, &ExtensionsSettingsOLD::resetSettings);
...
ExtensionsSettingsOLD::~ExtensionsSettingsOLD() {
    delete ui;
}

void ExtensionsSettingsOLD::loadSettings() {
...
void ExtensionsSettingsOLD::saveSettings() {
...
void ExtensionsSettingsOLD::resetSettings() {
...
void ExtensionsSettingsOLD::showEvent(QShowEvent *event) {
...
void ExtensionsSettingsOLD::exportUI() const {
...
void ExtensionsSettingsOLD::exportJson() const {
...
void ExtensionsSettingsOLD::exportXML() const {
