...
void Project1Composer::fillInstructions() {
    ...
    patternInstructions->add(new RelP(common, new P(name(H), pattern(back)), name(H1), right,
                                      biFunc(biFunc(param(HIP_CIRCUMFERENCE), num(4), new B::Divide()),
                                             num(1), new B::Subtract())));
    patternInstructions->add(new RelP(common, new P(name(W), pattern(back)), name(W1), right,
                                      vecFunc(name(H), pattern(back), name(H1), pattern(back), new V::Length())));
    patternInstructions->add(new RelP(common, new P(name(W), pattern(back)), name(W2), right,
                                      biFunc(biFunc(param(BUST_CIRCUMFERENCE), num(4), new B::Divide()),
                                             num(1), new B::Subtract())));
    patternInstructions->add(new RelP(common, new P(name(S), pattern(back)), name(S1), right,
    ...
    patternInstructions = new PatternInstructionsContainer(selectedPatterns);
    instructions->add(patternInstructions);
    patternInstructions->add(new RelP(common, new P(name(W), pattern(back)), name(AH), up,
    ...
    patternInstructions->add(new RelP(use_last_point, name(UB), up,
                                      biFunc(vecFunc(name(S), pattern(back), name(AH), pattern(back), new V::Length()),
                                             num(3), new B::Divide())));
    patternInstructions->add(new RelP(common, new P(name(H), pattern(back)), name(T), up,
    ...
    patternInstructions = new PatternInstructionsContainer(selectedPatterns);
    instructions->add(patternInstructions);
    patternInstructions->add(new RelP(common, new P(name(S), pattern(back)), name(N), right,
    ...
    patternInstructions->add(new RelP(common, new P(name(N1), pattern(back)), name(N3), left,
                                      biFunc(vecFunc(name(N2), pattern(back), name(N1), pattern(back), new V::Length()),
                                             num(2), new B::Divide())));
    patternInstructions->add(new RelP(common, new P(name(N), pattern(back)), name(S2), num(-18), param(SHOULDER_LENGTH)));
    patternInstructions->add(new RelP(common, new P(name(UB), pattern(back)), name(UB1), right,
                                      biFunc(param(BACK_WIDTH), num(2), new B::Divide())));
    patternInstructions->add(new RelP(common, new P(name(AH), pattern(back)), name(AH1), right,
                                      biFunc(param(BACK_WIDTH), num(2), new B::Divide())));
    patternInstructions->add(new RelP(use_last_point, name(AH2), num(45), num(1.5)));
    patternInstructions->add(new RelP(common, new P(name(AH), pattern(back)), name(AH3), right,
                                      vecFunc(name(W), pattern(back), name(W2), pattern(back), new V::Length())));
    patternInstructions->add(new RelP(use_last_point, name(AH4), left, num(1)));
    patternInstructions->add(new RelP(common, new P(name(N), pattern(back)), name(D), num(-18),
                                      biFunc(vecFunc(name(N), pattern(back), name(S2), pattern(back), new V::Length()),
                                             num(2), new B::Divide())));

    patternInstructions->add(new D(common, name(N), name(S2), new Vec(new P(name(D), pattern(back)), num(90), num(7)), num(2), num()));
    ...
    patternInstructions->add(new RelP(common, new P(name(H), pattern(front)), name(H1), left,
                                      biFunc(biFunc(param(HIP_CIRCUMFERENCE), num(4), new B::Divide()),
                                             num(1), new B::Add())));
    patternInstructions->add(new RelP(common, new P(name(W), pattern(front)), name(W1), left,
                                      vecFunc(name(H), pattern(front), name(H1), pattern(front), new V::Length())));
    patternInstructions->add(new RelP(common, new P(name(W), pattern(front)), name(W2), left,
                                      biFunc(biFunc(param(BUST_CIRCUMFERENCE), num(4), new B::Divide()),
                                             num(1), new B::Add())));
    patternInstructions->add(new RelP(common, new P(name(S), pattern(front)), name(S1), left,
                                      vecFunc(name(W), pattern(front), name(W2), pattern(front), new V::Length())));
    patternInstructions->add(new RelP(common, new P(name(S), pattern(front)), name(N), left,
                                      biFunc(param(NECK_CIRCUMFERENCE), num(6), new B::Divide())));
    patternInstructions->add(new RelP(use_last_point, name(N1), down,
                                      biFunc(biFunc(param(NECK_CIRCUMFERENCE), num(6), new B::Divide()),
                                             num(2), new B::Add())));
    patternInstructions->add(new RelP(common, new P(name(N), pattern(front)), name(S2), num(180 + 26), param(SHOULDER_LENGTH)));
    patternInstructions->add(new RelP(common, new P(name(UB), pattern(front)), name(UB1), left,
                                      biFunc(param(BACK_WIDTH), num(2), new B::Divide())));
    patternInstructions->add(new RelP(common, new P(name(AH), pattern(front)), name(AH1), left,
                                      biFunc(param(BACK_WIDTH), num(2), new B::Divide())));
    patternInstructions->add(new RelP(use_last_point, name(AH2), num(90 + 45), num(2.5)));
    patternInstructions->add(new RelP(common, new P(name(AH), pattern(front)), name(AH3), left,
                                      vecFunc(name(W), pattern(front), name(W2), pattern(front), new V::Length())));
    patternInstructions->add(new RelP(use_last_point, name(AH4), right, num(1)));
    patternInstructions->add(new RelP(common, new P(name(S), pattern(front)), name(B), down, param(BUST_HEIGHT)));
    ...
    patternInstructions->add(new RelP(common, new P(name(N), pattern(front)), name(D1),
