...
namespace Chrysalis {
    class Project1Composer: public BaseProjectComposer {
        struct PointName {
            ...
            static constexpr auto DW11 = "DW11";
            static constexpr auto DW12 = "DW12";
            static constexpr auto DW1A = "DW1A";
            static constexpr auto DW1T = "DW1T";
            static constexpr auto DW21 = "DW21";
            static constexpr auto DW22 = "DW22";
            static constexpr auto DW2A = "DW2A";
            static constexpr auto DW2T = "DW2T";
        };
    ...
    public:
        inline static const std::unordered_map<std::string, std::pair<double, double>> expectedBack = {
            ...
            {PointName::DW1, {7.6667, -42}},
            {PointName::DW2, {13.3333, -42}},
            {PointName::DW21, {14, -42}},
            {PointName::DW2T, {13.3333, -23}},
            {PointName::DW2A, {13.3333, -51}},
            {PointName::DW22, {12.6667, -42}},
            {PointName::DW1T, {7.6667, -21}},
            {PointName::DW11, {8.6667, -42}},
            {PointName::DW1A, {7.6667, -53}},
            {PointName::DW12, {6.6667, -42}}
        };
        inline static const std::unordered_map<std::string, std::pair<double, double>> expectedFront = {
            ...
            {PointName::DW1, {-8.5, -42}},
            {PointName::DW2, {-14.75, -42}},
            {PointName::DW1A, {-8.5, -51}},
            {PointName::DW1T, {-8.5, -28}},
            {PointName::DW11, {-7, -42}},
            {PointName::DW12, {-10, -42}},
            {PointName::DW2A, {-14.75, -49}},
            {PointName::DW2T, {-14.75, -30}},
            {PointName::DW21, {-13.75, -42}},
            {PointName::DW22, {-15.75, -42}},
        };
    };
}
