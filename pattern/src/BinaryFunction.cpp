...
double BinaryFunction::Name::evaluate(const args::number* operand1, const args::number* operand2) const {              \
...
double BinaryFunction::evaluate(const args::number* operand1, const args::number* operand2,
