...
double VectorFunction::Length::evaluate(const name* pointFrom, const pattern* patternFrom,
...
double VectorFunction::Angle::evaluate(const name* pointFrom, const pattern* patternFrom,
                                       const name* pointTo, const pattern* patternTo) const {
