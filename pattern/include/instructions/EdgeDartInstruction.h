...
namespace Chrysalis {
    ...
    SERIALIZE_DERIVED_MEMBERS(Chrysalis::EdgeDartInstruction, Chrysalis::BasePatternInstruction, edgePointFrom_, edgePointTo_, dartPoint_, angle_, length_, leg1Intake_, leg2Intake_)
    SERIALIZATION_CONSTRUCTOR(Chrysalis::EdgeDartInstruction, space_, selectedPatterns_, edgePointFrom_, edgePointTo_, dartPoint_, angle_, length_, leg1Intake_, leg2Intake_)
}
